export const PER_PAGE_FIRST_HOME = 4; // No of posts to be shown on first page.
export const PER_PAGE_REST = 16; // No of posts to be shown following page and after.
export const PER_PAGE_FIRST = 16;
export const getPageOffset = ( pageNo: any, per_page_first: number = PER_PAGE_FIRST ) => {
...
export const totalPagesCount = ( totalPostsCount: any, per_page_first: number = PER_PAGE_FIRST ) => {
 ...
 */
export const createPaginationLinks = ( currentPage: any, totalPages: any ) => {
